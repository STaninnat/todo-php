 ...
 *
 * Unit tests to verify type errors in MarkDoneTaskService.
 *
 * Ensures that invalid input types or constructor arguments
 * trigger TypeError, preventing unexpected runtime behavior.
 *
...
class MarkDoneTaskServiceTypeErrTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->service = new MarkDoneTaskService($taskQueries);
    }
    ...
    public function testConstructorWithInvalidTaskQueriesTypeThrowsTypeError(): void
    {
        ...
        /** @phpstan-ignore-next-line */
        new MarkDoneTaskService('not-a-TaskQueries');
    }
}
